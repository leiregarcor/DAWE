...
async function upload(formData) {
  try {
    ...
    console.log("Estado Carga: ", result.exito);

    output(
		`<p>Resultados del formulario:
			<ul>
 				<li>Nombre: ${result.first_name}</li>
 				<li>Telefono: ${result.telefono}</li>
 				<li>E-mail: ${result.email}</li>
				<li>Libro: ${result.books}</li>
 				<li>Cantidad: ${result.cantidad}</li>
			</ul>
		`
	);
...
function enviar(){
	...
	const fileField = document.getElementById("nombre").value;
	formData.append("first_name",fileField)
	formData.append("telefono",document.getElementById("telefono").value)
	formData.append("email",document.getElementById("email").value)
	formData.append("books",document.getElementById("books").value)
	formData.append("cantidad",document.getElementById("cantidad").value)
	//formData.append("fileselect",document.getElementById("upload").fileselect)
	//ormData.append()
	//console.log(formData)
	//var file = document.getElementById("upload").fileselect;
